// /Users/oystein/nettsider/smootday-v2-feb-26/src/app/(public)/benefits/sections/03BenefitsOmega.tsx

import Image from "next/image";
import { omegaClaims } from "./claims";
  ...
  return (
    ...
    >
      <div className="relative w-full overflow-hidden rounded-3xl aspect-4/3">
        <Image src="/products/omega2.png" alt="Omega-3" fill className="object-cover object-center" />
      </div>
      ...
      <div className="mt-4">
        ...
        <p className="mt-2 text-base leading-7" style={{ color: "var(--slate)" }}>
          EPA og DHA – en enkel del av Essentials-rutinen.
        </p>
...
export default function S03BenefitsOmega() {
  return (
    <section id="benefits-omega" className="mx-auto w-full max-w-6xl px-6 pb-10">
      <div
      ...
      >
        <div className="grid gap-8 lg:grid-cols-[2fr_1fr] lg:items-start">
          ...
          <div className="min-w-0">
            ...
            >
              Omega-3 – helsepåstander
            </h2>

            <p className="mt-4 text-lg leading-8" style={{ color: "var(--slate)" }}>
              Under viser vi helsepåstander knyttet til EPA og DHA (Omega-3), formulert som
              godkjente påstander i EU/EØS.
            </p>

            <div className="mt-8">
              {omegaClaims.map((c, idx) => (
