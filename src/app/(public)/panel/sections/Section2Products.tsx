...
export default function Section2Products() {
  ...
  // Når du bytter produkt: velg første variant automatisk
  useEffect(() => {
  ...
  // ✅ getQty teller også :sub (via normalizeVariantId i cart.ts)
    ...
    <section id="produkter" className="mx-auto w-full max-w-6xl px-6 py-10">
      ...
      >
        <div className="grid gap-6 md:grid-cols-2 md:items-start">
          ...
          <div className="order-1 md:order-2 min-w-0">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              <button
                ...
                disabled={soldOut}
                className={baseBtn}
                style={{ ...outlineStyle, ...(soldOut ? disabledStyle : null) }}
              >
              ...
              <button
                ...
                disabled={soldOut}
                className={baseBtn}
                style={{ ...activePrimaryStyle, ...(soldOut ? disabledStyle : null) }}
              >
          ...
          {/* ✅ LEFT on desktop, SECOND on mobile (image below controls on mobile) */}
